# Generated by Django 5.0.3 on 2024-06-29 18:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rental_place', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rentals.rentalplace', verbose_name='مكان الاجار')),
                ('tenant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contracts', to='rentals.tenant', verbose_name='المستأجر')),
            ],
        ),
    ]
